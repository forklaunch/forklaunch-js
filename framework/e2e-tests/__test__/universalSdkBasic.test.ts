...
describe('universalSdkBasic', async () => {
  let server: Server;
  let client: MapToSdk<ZodSchemaValidator, typeof sampleSdkClient>;
  ...
  it('should call postTest', async () => {
    ...
    const postTest = await client.sample.path.a.b.post['2.0.0']({
      headers: {
  ...
  it('should call jsonPatchTest', async () => {
    ...
    const jsonPatchTest = await client.sample.path.a.b.patch({
      headers: {
        authorization:
  ...
  it('should call multipartTest', async () => {
    ...
    const multipartTest = await client.sample.path.a.b.multipart({
      headers: {
        'x-test': 'test'
      },
      body: {
  ...
  it('should call urlEncodedFormTest', async () => {
    ...
    const urlEncodedFormTest = await client.sample.c.d.urlEncodedForm({
      params: {
        id: '123'
      },
      body: {
  ...
  it('should call filePostTest', async () => {
    ...
    const filePostTest = await client.sample.c.d.file({
