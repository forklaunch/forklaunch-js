...
export interface PathOrMiddlewareBasedHandler<
  RouterHandler
> extends PathBasedHandler<RouterHandler> {
  (...args: RouterHandler[]): unknown;
}

export interface NestableRouterBasedHandler<
  RouterHandler,
  Router
...
export interface ExpressLikeRouter<RouterHandler, Router> extends ServerOptions<
