...
// @types/node
pub(crate) const TYPES_NODE_VERSION: &str = "^26.2.0";
// jest
...
// typescript-eslint
pub(crate) const TYPESCRIPT_ESLINT_VERSION: &str = "^8.67.0";
// vitest
...
// globals
pub(crate) const GLOBALS_VERSION: &str = "^17.9.0";
// husky
...
pub(crate) const BETTER_AUTH_MIKRO_ORM_VERSION: &str = "~0.5.4";
...
pub(crate) const BILLING_BASE_VERSION: &str = "~1.0.30";
// @forklaunch/implementation-billing-stripe
pub(crate) const BILLING_STRIPE_VERSION: &str = "~1.1.32";
// @forklaunch/implementation-iam-base
pub(crate) const IAM_BASE_VERSION: &str = "~1.0.30";
...
pub(crate) const WORKER_REDIS_VERSION: &str = "~1.0.31";
// @forklaunch/implementation-worker-database
pub(crate) const WORKER_DATABASE_VERSION: &str = "~1.0.31";
// @forklaunch/implementation-worker-kafka
pub(crate) const WORKER_KAFKA_VERSION: &str = "~1.0.31";
// @forklaunch/infrastructure-redis
pub(crate) const INFRASTRUCTURE_REDIS_VERSION: &str = "~1.4.10";
// @forklaunch/infrastructure-s3
pub(crate) const INFRASTRUCTURE_S3_VERSION: &str = "~1.4.10";
// @forklaunch/interfaces-billing
pub(crate) const BILLING_INTERFACES_VERSION: &str = "~1.0.30";
// @forklaunch/interfaces-iam
pub(crate) const IAM_INTERFACES_VERSION: &str = "~1.0.29";
...
pub(crate) const VALIDATOR_VERSION: &str = "~1.2.24";
// @mikro-orm/core
pub(crate) const MIKRO_ORM_CORE_VERSION: &str = "7.1.11";
// @mikro-orm/migrations
pub(crate) const MIKRO_ORM_MIGRATIONS_VERSION: &str = "7.1.11";
...
pub(crate) const MIKRO_ORM_DATABASE_VERSION: &str = "7.1.11";
// @mikro-orm/seeder
pub(crate) const MIKRO_ORM_SEEDER_VERSION: &str = "7.1.11";
// @opentelemetry/api
...
// better-auth
pub(crate) const BETTER_AUTH_VERSION: &str = "^1.6.26";
// bullmq
pub(crate) const BULLMQ_VERSION: &str = "^6.0.10";
// better-sqlite3
pub(crate) const BETTER_SQLITE3_VERSION: &str = "^13.0.3";
// dotenv
pub(crate) const DOTENV_VERSION: &str = "^17.4.2";
// jose
pub(crate) const JOSE_VERSION: &str = "^6.2.8";
// sqlite3
pub(crate) const SQLITE3_VERSION: &str = "^6.0.1";
// stripe
pub(crate) const STRIPE_VERSION: &str = "^22.4.0";
// uuid
...
// @mikro-orm/cli
pub(crate) const MIKRO_ORM_CLI_VERSION: &str = "7.1.11";
// @types/express
