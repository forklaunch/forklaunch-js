...
"#;
    ...
    fn test_transform_server_ts_with_watermark_issue() {
        ...
        let watermark_start = "/** \n* Generated by ForkLaunch";
        assert!(
            transformed_code.starts_with(watermark_start),
            "Watermark should be at the top of the file, but file starts with: {}",
            &transformed_code[..watermark_start.len().min(transformed_code.len())]
        );
    }
}
