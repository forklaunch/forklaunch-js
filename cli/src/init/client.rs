...
//         command("client", "Initialize a new client")
//             .alias("frontend")
//             .alias("fe")
//             .arg(Arg::new("name").help("The name of the client"))
//             .arg(
//                 Arg::new("base_path")
//                     .short('p')
//                     .long("path")
//                     .help("The application path to initialize the client in"),
//             )
//             .arg(
//                 Arg::new("description")
//                     .short('D')
...
//         let mut config_data: ClientManifestData = ClientManifestData {
