    ...
    core::{
        ...
        package_json::{
            ...
            package_json_constants::{
                ...
                application_docs_script, application_migrate_script, application_seed_script,
                application_setup_script, application_test_script, application_up_packages_script,
                project_clean_script, project_test_script, AJV_VERSION, APP_DEV_BUILD_SCRIPT,
                APP_DEV_SCRIPT, APP_FORMAT_SCRIPT, APP_LINT_FIX_SCRIPT, APP_LINT_SCRIPT,
                APP_PREPARE_SCRIPT, COMMON_VERSION, CORE_VERSION, DOTENV_VERSION, ESLINT_VERSION,
                EXPRESS_VERSION, GLOBALS_VERSION, HUSKY_VERSION, HYPER_EXPRESS_VERSION,
                JEST_TYPES_VERSION, JEST_VERSION, LINT_STAGED_VERSION, MIKRO_ORM_CORE_VERSION,
                ...
                SORT_PACKAGE_JSON_VERSION, TSX_VERSION, TS_JEST_VERSION, TYPEBOX_VERSION,
...
fn generate_application_package_json(
    ...
    let package_json_contents = ApplicationPackageJson {
        ...
        scripts: Some(ApplicationScripts {
            ...
            database_setup: Some(application_setup_script(data.runtime.as_str()).to_string()),
            ...
            seed: Some(
                application_seed_script(data.runtime.as_str(), data.database.as_str()).to_string(),
            ),
            test: Some(
