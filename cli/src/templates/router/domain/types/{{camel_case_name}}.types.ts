...
export type {{pascal_case_name}}RequestDto = Schema<typeof {{pascal_case_name}}RequestSchema, SchemaValidator>;

// Exported type that matches the response schema
export type {{pascal_case_name}}ResponseDto = Schema<typeof {{pascal_case_name}}ResponseSchema, SchemaValidator>;