...
RUST_BACKTRACE=1 cargo run --release init service service-test -d postgresql -p service-test-node-application -D "Test service"
RUST_BACKTRACE=1 cargo run --release init service service-test-mongodb -d mongodb -p service-test-node-application -D "Test service"
...
RUST_BACKTRACE=1 cargo run --release init service service-test -d postgresql -p service-test-bun-application -D "Test service"
RUST_BACKTRACE=1 cargo run --release init service service-test-mongodb -d mongodb -p service-test-bun-application -D "Test service"
