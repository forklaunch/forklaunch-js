...
export class Application<SV extends AnySchemaValidator> {
   ...
   */
  use(
    router: Router<SV> | RequestHandler<SV>,
    ...args: (Router<SV> | RequestHandler<SV>)[]
  ): this {
    if (router instanceof Router) {
      ...
      this.internal.use(
        router.basePath,
        ...(args as unknown as ExpressRequestHandler[]),
        router.internal
      );
      return this;
    }
  ...
  implements ForklaunchRouter<SV>
{
   ...
   * @param {RequestHandler<SV, P, ResBodyMap | string, ReqBody, ReqQuery, LocalsObj, StatusCode>} requestHandler - The request handler.
  ...
  > {
    return async (
      req: Request<SV, P, ResBodyMap | string, ReqBody, ReqQuery, LocalsObj>,
      res: Response<ResBodyMap | string, LocalsObj, StatusCode>,
      next?: NextFunction
    ) => {
      if (!requestHandler) {
   ...
   * @template LocalsObj - The type of local variables.
   * @template StatusCode - The type of status code.
   * @param {RequestHandler<SV, P, ResBodyMap, ReqBody, ReqQuery, LocalsObj, StatusCode>[]} functions - The provided functions.
   * @returns {RequestHandler<SV, P, ResBodyMap, ReqBody, ReqQuery, LocalsObj, StatusCode>} - The extracted controller function.
   ...
   * @param {...SchemaRequestHandler<SV, P, ResBodyMap, ReqBody, ReqQuery, LocalsObj>[]} functions - The handler functions.
   */
  get<
  ...
  >(
    ...
    contractDetails: PathParamHttpContractDetails<SV, P, ResBodyMap, ReqQuery>,
  ...
  >(
    path: string | RegExp | (string | RegExp)[],
    contractDetails: HttpContractDetails<SV, P, ResBodyMap, ReqBody, ReqQuery>,
    ...functions: SchemaRequestHandler<
      SV,
      P,
      ResBodyMap,
